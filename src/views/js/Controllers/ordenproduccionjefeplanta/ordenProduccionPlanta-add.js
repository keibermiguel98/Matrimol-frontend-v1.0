...
const rutaAbsoluta = path.join(__dirname, 'tables-ordenes-autorizaciones.html')
...
function addProduct(e) {
  ...
  if (productos == '') {
    ...
    productos.forEach((producto) => {
      if (producto.idProduct == idProduct.value) {
    ...
    if(valor == ''){
       ...
       socket.on('getconfig:data',(data)=>{
        data.forEach(config=>{
          ...
          codigoorden.value = config.siglasOrdenProduccion + '-'+ numinit.value
          numord.innerText = numOrdenProduccion.value
          caracter.innerText = config.siglasOrdenProduccion + '-'+ numinit.value
        })
       })
    }else{
      ...
      socket.on('get:ultimaorden', results=>{
        ...
        numinit.value = ninit
        revision.value = config.revision 
        codigoorden.value = config.caracteres + '-' + numinit.value
        numord.innerText =   numOrdenProduccion.value
